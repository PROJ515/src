...
#/* Second attempt at moving the gummi arm through code - lets try python!!*/
...
def move_group_python_interface_tutorial():
  ...
  pose_target.position.x = 0.068
  pose_target.position.y = -0.144
  pose_target.position.z = -0.120
...
if __name__=='__main__':
  try:
    ...
    #gummi_play_python_interface_tutorial()
