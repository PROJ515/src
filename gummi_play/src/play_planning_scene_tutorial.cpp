/*********************************************************************
/* Third attempt at moving the gummi arm through code - back to c++...*/
...
{
  const double* joint_values = kinematic_state.getJointPositions("shoulder_pitch");
