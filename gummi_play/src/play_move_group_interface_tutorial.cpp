...
{
  ros::init(argc, argv, "play_move_group_interface_tutorial");
  ros::NodeHandle node_handle;
  ros::AsyncSpinner spinner(1);
  spinner.start();
   ROS_WARN("NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME ");
  // BEGIN_TUTORIAL
  //
  // Setup
  // ^^^^^
...
//  static const std::string PLANNING_GROUP = "gummi";
   ROS_WARN("NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME ");

  // The :move_group_interface:`MoveGroup` class can be easily
  // setup using just the name of the planning group you would like to control and plan for.
  //PROBLEM HERE   //PROBLEM HERE   //PROBLEM HERE   //PROBLEM HERE   //PROBLEM HERE   //PROBLEM HERE   //PROBLEM HERE   //PROBLEM HERE   //PROBLEM HERE 
  ...
  /* Uncomment below line when working with a real robot */
   ROS_INFO("Gonna try and do a moving...");
   ROS_WARN("NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME NOTICE ME ");
   move_group.move();
   ROS_INFO("Moving attempted, did it go moving?");
